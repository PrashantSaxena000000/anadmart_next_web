...
import "./PaginationTracking.scss";

const PaginationTracking = ({ paginaionMeta, setPageNo, total_page }) => {
      const totalPages = [];
    
      for (let i = 1; i < total_page + 5; i++) {
        totalPages.push(i);
      }
...
export default PaginationTracking
