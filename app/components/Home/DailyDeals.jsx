...
import MobileDrawer from "../../common/drawer/MobileDrawer";
import Drawer from "react-modern-drawer";
import "react-modern-drawer/dist/index.css";

const DailyDeals = ({ head, mydata }) => {
  ...
  const handleAddCart = (data) => {
    if (isLoggedIn) {
      if (!isMobile) {
        ...
        setAdd({ ...add, [data.id]: isOpen[data.id] ? false : true });
      }
  ...
  return (
    <>
      <div className={styles.dailyDeals_wrapper}>
                            ...
                            {[1, 2, 3, 4, 5].map((star) => (
                              <svg
                                ...
                                style={{
                                  cursor: "pointer",
                                  // stroke:
                                  //   star <= items?.avg_rating ? "" : "#D9D9D9",
                                  fill:
                                    star <= items?.avg_rating
                                      ? "#FFAB07"
                                      : "#D9D9D9",
                                }}
                              >
                            ...
                            <div className={styles.priceAndAdd}>
                              ...
                              {items?.is_available}
                                ...
                                <p>
                                  ...
                                  <span>${items?.variants[0]?.price}</span>
                                </p>
                              )}
                            </div>{" "}
                          </div>
